  ...
  <div class="container">
    <ul class="navbar-list">
        ...
        <?php
          ...
          $url3 = 'location.href="'.$profile.'"';
          $url4 = 'location.href="'.$profile2.'"';
      
          if (($_SESSION['type']==0)) {            
            echo '<li class="navbar-item"><a class="navbar-link" onclick='.$url.'>Joukkueet</a></li>';
            echo '<li class="navbar-item"><a class="navbar-link" onclick='.$url4.'>Profiili <i style="position: absolute; top: 6px; right: 21px; display: inline; font-size: 14px; "class="material-icons">expand_more</i></a></li>';
          } else {
